            ...
            <div class="col-md-12">
                <div class="col-middle">
                    <div class="text-center text-center">
                        <h1 class="error-number">Sorry ... ! <br>Your Account Is Not Active Right Now</h1>
                        <!-- <h1>Please check your email  <span style="font-size: 30px;">OR</span> Contact FDC team</h1> -->
                        <p>
                           <h3>Your account is not active or disabled. <br> To activate please check your email or contact {{ config('app.name', 'FDC APP') }} team.</h3>
                        </p>
